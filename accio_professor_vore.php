...
<?php
//Substitucions
$substituts = $db->query("SELECT S.*, P.NOM FROM Substitucions S LEFT JOIN Professor P ON  S.PROFE=P.ID WHERE S.SUBSTITUT=".$profe_id."");
$cadena_substitucio = "";
...
<div class="container-fluid">     
	<h4><?=PROFESSOR_HORARI;?>: <?=$profe_nomprofe;?> (<?=$profe_id;?>) <?=$cadena_substitucio;?></h4> 
