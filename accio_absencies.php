  	...
  	<form id="formulari" method="post" action="index.php?accio=absencies_crear">
   		<div class="form-group">
			...
			<div>
				...
				<button type="button" class="btn btn-outline-primary btn-sm" onclick="formacio('[IT] ')"><?=ABSENCIES_LABEL_IT;?></button>
				<button type="button" class="btn btn-outline-primary btn-sm" onclick="formacio('[AE] ')"><?=ABSENCIES_LABEL_AE;?></button>
				<button type="button" class="btn btn-outline-primary btn-sm" onclick="formacio('[ER] ')"><?=ABSENCIES_LABEL_ER;?></button>
			</div>			
			<script>
				function formacio(valor){
					document.getElementById("inputActivitat").value=valor;					
				}
			</script>			
			<br>
      		<div class="form-group">
