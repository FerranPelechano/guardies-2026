...
<body>
	...
	//Usuari mínim sols pot vore dia actual
			...
			<form class="form-inline my-2 my-lg-0">
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						...
						<li><a class="dropdown-item" href="index.php?accio=guardies"><?= INDEX_GUARDIES; ?></a></li>
						<li><a class="dropdown-item" href="index.php?accio=edocent_reunio"><?= INDEX_EDOCENT_REUNIO; ?></a></li>
				...
				?>
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							...
							<li><hr class="dropdown-divider"></li>
							<li><a class="dropdown-item" href="index.php?accio=api_powerautomate"><?= INDEX_API_TITUL; ?></a></li>
							<li><hr class="dropdown-divider"></li>
							...
							<li><a class="dropdown-item" href="index.php?accio=control_llista_professor"><?= INDEX_CONTROL_LLISTA_PROFESSOR; ?></a></li>							
							<li><a class="dropdown-item" href="index.php?accio=professor_qr"><?= INDEX_PROFESSOR_QR; ?></a></li>							
						</ul>
					</div>
				<?php
				}
	...
	switch ($accio) {
		...
		case "mostrar":
			...
			break;
		case "absencies":
			require_once "index_sense-permisos-minims.php";
		...
		case "aules":			
			...
			break;	
		case "guardies":			
			require_once "accio_guardies.php";
			break;				
		...
		case "control_llista":
			...
			break;
		case "control_llista_professor":
			require_once "index_sense-permisos.php";
			require_once "accio_control_llista_professor.php";
			require_once "accio_control_llista_professor_anual.php";						
			break;
		...
		case "edocent":
			...
			break;
		case "edocent_reunio":
			require_once "accio_edocent_reunio.php";
			break;
		case "edirectiu":			
		...
		case "professor_qr":
			require_once "index_sense-permisos.php";
			require_once "accio_professor_qr.php";
			break;
		...
		case "reserves_elimina":
			...
			require_once "accio_reserves_llista.php";
			break;		
		case "api_powerautomate":
			require_once "index_sense-permisos.php";
			require_once "accio_api_powerautomate.php";
			break;	
		//Acció per defecte
		default:
			require_once "accio_mostrar.php";
