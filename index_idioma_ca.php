...
//accio_absencies.php
define("ABSENCIES_TITUL", "Introdueix absències de professorat");
...
define("ABSENCIES_LABEL_PF", "Permís de Formació [PF]");
define("ABSENCIES_LABEL_A5", "Visita a Empresa FE [A5]");
define("ABSENCIES_LABEL_IT", "Baixa Mèdica [IT]");
define("ABSENCIES_LABEL_AE", "Activitat Extraescolar [AE]");
define("ABSENCIES_LABEL_ER", "Erasmus [ER]");
...
//accio_assigna.php
define("ASSIGNA_TITUL", "Introdueix assignació");
...
//accio_edocent_reunio.php
define("EDOCENT_REUNIO_TITUL", "Reunions d'Equip Docent");
define("EDOCENT_REUNIO_LABEL_PROFES", "Seleccionar Professors");
define("EDOCENT_REUNIO_LABEL_SUBMIT", "Mostrar Horari");
define("EDOCENT_REUNIO_HORARI", "Horari Solapat Reunió d'Equip Docent");
define("EDOCENT_REUNIO_HORA", "Hora");
define("EDOCENT_REUNIO_PROFES_SELECCIONATS", " professors seleccionats)");
//accio_edirectiu.php
...
define("MOSTRAR_CONTROL_CONVIVENCIA", "Altres (Convivències/Banys/Consergeria)");
define("MOSTRAR_PATI_1", "Pati Porta A");
define("MOSTRAR_PATI_2", "Pati Zona A");
define("MOSTRAR_PATI_3", "Pati Porta B");
define("MOSTRAR_PATI_4", "Pati Cantina");
define("MOSTRAR_PATI_5", "Pati Porta C");
define("MOSTRAR_PATI_6", "Pati Banys");
define("MOSTRAR_PATI_7", "Consergeria");
//accio_notes.php
define("NOTES_TITUL", "Introdueix observacions");
...
//accio_professor.php
define("PROFESSOR_TITUL", "Introdueix professor");
define("PROFESSOR_TOTAL", "Total");
define("PROFESSOR_TITUL_VORE", "Horari de professor");
define("PROFESSOR_LABEL_PROFE", "Professor a editar (Deixar sense seleccionar per introduir un nou professor)");
...
//accio_professor_qr.php
define("PROFESSOR_QR_TITUL_TAULA", "QRs dels professors");

//accio_professor_sessio.php
define("PROFESSOR_SESSIO_TITUL", "Introdueix sessió");
...
define("SUBSTITUCIO_TITUL", "Introdueix professor");
...
define("INDEX_EDOCENT_REUNIO", "Planificar Reunions");
...
define("INDEX_CONTROL_MANUAL", "Control Horari");
define("INDEX_CONTROL_LLISTA", "Control Llista Detalls");
...
define("INDEX_GUARDIES", "Guardies");
define("INDEX_PROFESSOR_QR", "QR Professors");
define("INDEX_CONTROL_LLISTA_PROFESSOR", "Control Professor Mensual");
//index_config.php
...
define("CONTROL_TH_6", "Map");
define("CONTROL_TH_7", "Total = Acumulat - Horari");
define("CONTROL_TH_8", "Accions");
define("CONTROL_LLISTA_ELIMINA", "Elimina");
define("INDEX_CONTROL_MANUAL_TORNAR", "Tornar al Control Manual");
define("INDEX_CONTROL_MANUAL_CLEAR", "Netejar Valors");
define("INDEX_CONTROL_MANUAL_DATA", "Data");
define("INDEX_CONTROL_MANUAL_HORA", "Hora");
define("INDEX_CONTROL_MANUAL_DATAHORA", "Data i Hora Manuals (Permís admin)");
//index_sense-permisos.php
define("SENSEPERMISOS_1", "Sense permisos per executar");
define("SENSEPERMISOS_2", "... Què fas ací?");
//index_guardies.php
define("GUARDIES_TITUL", "Llistat de Guardies");
//api_powerautomate.php
define("INDEX_API_TITUL", "API Power Automate");
define("API_TAULA_1", "ID");
define("API_TAULA_2", "Professor");
define("API_TAULA_3", "Data");
define("API_TAULA_4", "Hora");
define("API_TAULA_5", "Cobertura per");
define("API_TAULA_6", "Activitat");
define("API_TAULA_7", "Observacions");
define("API_TAULA_8", "Mail");
//accio_control_llista_professor.php
define("INDEX_CONTROL_LLISTA_PROFESSOR_SUBMIT", "Enviar");
define("INDEX_CONTROL_LLISTA_PROFESSOR_TITLE", "Control Horari de Professor");
define("INDEX_CONTROL_LLISTA_PROFESSOR_TH1", "Data");
define("INDEX_CONTROL_LLISTA_PROFESSOR_TH2", "Treballat");
define("INDEX_CONTROL_LLISTA_PROFESSOR_TH3", "Horari");
define("INDEX_CONTROL_LLISTA_PROFESSOR_TH4", "Diferència");
define("INDEX_CONTROL_LLISTA_PROFESSOR_TH5", "IN/OUT");
?>